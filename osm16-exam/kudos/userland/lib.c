...
{
  return (int)_syscall(SYSCALL_MSG_MAILBOX, (uintptr_t)mid, 0, 0);
}
...
{
  return (int)_syscall(SYSCALL_MSG_RECEIVE,
    (uintptr_t)mid, (uintptr_t)dest, 0);
}
...
{
  return (int)_syscall(SYSCALL_MSG_SEND,
    (uintptr_t)mid, (uintptr_t)size, (uintptr_t)src);
}
