...
The problem size of external fragmentation raises with the number of middle block-removals there has been, since the different allocated memory blocks will be scattered around in memory.
