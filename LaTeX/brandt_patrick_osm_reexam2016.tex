...
According to the total time available to P6, this TAT should be no more than 232, however my handrun appeared to give me 235, and so. If there is found mistakes in this particular algorithm, pictures of run by hand can be found in Appendix.
...
With 4,096-byte blocks, one would be able to store 1,024 four-byte pointers in an index block. And two levels of indexes allow 1,048,576 data blocks and a file size of up to 4 GB.
...
\subsection*{Kudos Implementation}
...
``Data fragmentation occurs when a collection of data in memory is broken up into many pieces that are not close together. It is typically the result of attempting to insert a large object into storage that has already suffered external fragmentation'' \footnote{\url{https://en.wikipedia.org/wiki/Fragmentation_(computing)}}

The problem size of external fragmentation raises with the number of middle block-removals there has been, because the different allocated memory blocks will be scattered around in memory.
...
\begin{table}[H]
    \centering
    \caption{External Fragmentation Example}
    \label{my-label}
    \begin{tabular}{llll}
        Iteration                                                                                                                      & \multicolumn{3}{l}{Blocks}                                                                                                                                                                                         \\ \hline
        \multicolumn{1}{|l|}{Memory is empty}                                                                                          & \multicolumn{1}{l|}{\cellcolor[HTML]{32CB00}{\color[HTML]{333333} }} & \multicolumn{1}{l|}{\cellcolor[HTML]{32CB00}{\color[HTML]{333333} }} & \multicolumn{1}{l|}{\cellcolor[HTML]{32CB00}{\color[HTML]{333333} }} \\ \hline
        \multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}Large object is inserted\\ into multiple blocks\end{tabular}}                  & \multicolumn{1}{l|}{\cellcolor[HTML]{E7E500}}                        & \multicolumn{1}{l|}{\cellcolor[HTML]{E7E500}}                        & \multicolumn{1}{l|}{\cellcolor[HTML]{E7E500}}                        \\ \hline
        \multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}A block in the middle is\\ removed and memory is\\ now scattered\end{tabular}} & \multicolumn{1}{l|}{\cellcolor[HTML]{E7E500}{\color[HTML]{333333} }} & \multicolumn{1}{l|}{\cellcolor[HTML]{FE0000}{\color[HTML]{333333} }} & \multicolumn{1}{l|}{\cellcolor[HTML]{E7E500}{\color[HTML]{333333} }} \\ \hline
    \end{tabular}
\end{table}


Green indicates free memory and Yellow indicates nicely used memory while Red indicates that the block is placed very inconvenient.
...
My new implementation is a very poor hard-coded version of the described algorithm.

The idea is to keep track of more than one structure, allowing for a shorter running time. Thus this ......
